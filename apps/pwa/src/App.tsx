...
const COPY = {
  en: {
    ...
    preclinical: "This is a preclinical organizer, not a medical service. No clinician monitors this record.",
  ...
  my: {
    ...
    preclinical: "ဤစနစ်သည် စမ်းသပ်ဆဲမှတ်တမ်းကူညီစနစ်ဖြစ်ပြီး ဆေးကုသမှုဝန်ဆောင်မှု မဟုတ်ပါ။ ဆရာဝန်က ဤမှတ်တမ်းကို စောင့်ကြည့်နေခြင်း မရှိပါ။",
    ...
    notDiagnosis: "ဤအချက်များသည် မေးခွန်းများကို စုစည်းရန်သာဖြစ်ပြီး ရောဂါအတည်ပြုချက် မဟုတ်ပါ။",
    save: "သိမ်းရန်",
