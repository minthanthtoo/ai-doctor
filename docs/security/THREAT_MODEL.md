...
| T-05 | PHI enters logs, push text, URLs or analytics | Opaque schema, fixed generic push, no analytics | Schema/API tests; planned captured-log audit | Partial | Automated sensitive-fixture surface scan |
